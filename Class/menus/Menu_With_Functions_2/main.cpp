...
int main(int argc, char** argv) {
    ...
    do {
        ...
        cout << "Type 1 for Sum of sequence" << endl;
        cout << "Type 2 for Books problem" << endl;
        cout << "Type 3 for Bank Charges problem" << endl;
        cout << "Type 4 for Runners problem" << endl;
        cout << "Type 5 for Pattern" << endl;
        cout << "Type 6 for " << endl;
        cout << "Type 7 for " << endl;
        cout << "Type 8 for " << endl;
...
void problem1()
{
    ...
    //Declare Variables
    int usrNum, //User number inputted
